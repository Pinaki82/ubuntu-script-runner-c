...
void instruction(void) {
  ...
  printf("* Maintain a copy of your modifications in the \'.config\' folder in\n    a separate directory for emergencies.\n");
  printf("* Extract the \'.config.zip\' and look inside the extracted \'.config\' folder\n    for example configurations.\n");
  printf("* Replace YOURUSERNAME with your Linux username.\n");
  printf("\n");
  printf("--------------------\n");
  printf("* In the config files, \'#\' at the beginning of a line is\n    a comment ignored by the program.\n");
  ...
  printf("\n");
  printf("* \'installcommand.txt\' should contain the install command,\n    e.g., install on Debian/Ubuntu/Fedora and -S on Arch.\n");
  printf("\n");
  printf("* \'package_manager.txt\' should contain the name of the package manager,\n    e.g., \'apt\' on Debian/Ubuntu, \'dnf\' on Fedora and \'pacman\' on Arch.\n");
  printf("\n");
  printf("* \'renew_system.txt\' should contain the update-related commands.\n");
  printf("\n");
  printf("* Of them, you'll need to update the apps.txt file regularly\n    whenever you want to add new packages to your system.\n    All other files need to be modified only once.\n");
  printf("\n");
  ...
  printf("\n");
  printf("\n");
  printf("* Note that the program doesn't uninstall any package if\n    it is not found in the list of apps aka \'apps.txt\'.\n");
  printf("\n");
  printf("--------------------\n");
  printf("RESTORING FROM A BACKUP:\n");
  printf("Backups are created using rsync's --relative (-R) option, which\n");
  printf("preserves the original directory structure beneath the backup\n");
  printf("destination.\n\n");
  printf("Example backup layout:\n\n");
  printf("  /mnt/backup/home/username/Documents\n");
  printf("  /mnt/backup/home/username/.config\n\n");
  printf("To restore all backed up files:\n\n");
  printf("  sudo rsync -a /mnt/backup/home/username/ /home/username/\n\n");
  printf("To restore a single directory:\n\n");
  printf("  sudo rsync -a \\\n");
  printf("    /mnt/backup/home/username/Documents/ \\\n");
  printf("    /home/username/Documents/\n\n");
  printf("⛔❗ Always review the source and destination paths carefully before\n");
  printf("running a restore command. ❗\n");
}
